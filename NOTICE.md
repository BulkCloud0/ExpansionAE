...
- AdvancedAE: Pedroksl and contributors. Reference branch `forge/1.20.1`, commit `3137d63403dd35211c886744f094886b6a81e76a`, version `1.3.6-1.20.1`. Upstream Gradle metadata declares LGPL-3.0. Its features are not yet implemented in this development checkpoint.
...
The ExpandedDuality, ExpandedInterfaceTile, ExpandedInterfaceBlock, ExpandedContainer and ExpandedScreen classes derive from AE2 and retain original copyright notices. Modified 2026-09-18 for configurable inventory sizes, registry separation and custom layouts. ExtendedAE texture files are copied without modification and their model references are adapted to the ExpansionAE namespace.
