...
// Adapted for ExpansionAE on 2026-09-18; retained for legacy interface crafting jobs.
...
public class ExpandedCraftingTracker {
    ...
    public ExpandedCraftingTracker(final ICraftingRequester o, final int size) {
        this.owner = o;
        this.size = size;
    }
    ...
    public ImmutableSet<ICraftingLink> getRequestedJobs() {
        ...
        return ImmutableSet.copyOf(java.util.Arrays.stream(this.links).filter(java.util.Objects::nonNull).collect(java.util.stream.Collectors.toList()));
    }
