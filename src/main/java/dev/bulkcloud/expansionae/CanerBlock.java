...
public final class CanerBlock extends AEBaseTileBlock<CanerTile> {
    public CanerBlock() { super(defaultProps(Material.IRON)); }
    ...
    public ActionResultType onActivated(World world, BlockPos pos, PlayerEntity player, Hand hand,
        ...
        CanerTile tile = getTileEntity(world, pos);
        ...
        if (!world.isRemote()) {
            ContainerOpener.openContainer(CanerContainer.TYPE, player,
