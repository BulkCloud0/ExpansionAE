...
// Adapted from AE2 8.4 for a 20-cell ExtendedAE-compatible drive.
...
public class ExpandedDriveTile extends AENetworkInvTileEntity implements IChestOrDrive, IPriorityHost {

    private static final long BIT_POWER_MASK = 1L << 61;
    ...
    private final Item[] cellItems = new Item[20];
    ...
    public ExpandedDriveTile(TileEntityType<?> tileEntityTypeIn) {
    ...
    protected void writeToStream(final PacketBuffer data) throws IOException {
        ...
        for (int x = 0; x < this.getCellCount(); x++) {
            ...
            final long i = (long) o << BIT_CELL_STATE_BITS * x;
            newState |= i;
        }
    ...
    public CellState getCellStatus(final int slot) {
        if (isRemote()) {
            final int cellState = (int) (this.state >> slot * BIT_CELL_STATE_BITS & BIT_CELL_STATE_MASK);
    ...
    public ItemStack getItemStackRepresentation() {
        return new ItemStack(ExpansionAE.EX_DRIVE_ITEM.get());
    }
    ...
    public ContainerType<?> getContainerType() {
        return ExpandedDriveContainer.TYPE;
    }
