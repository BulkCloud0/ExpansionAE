...
public final class ReactionChamberScreen extends UpgradeableScreen<ReactionChamberContainer> {
    ...
    private final Button[] outputButtons = new Button[net.minecraft.util.Direction.values().length];
    ...
    protected void init() {
        super.init();
        net.minecraft.util.Direction[] directions = net.minecraft.util.Direction.values();
        for (int i = 0; i < directions.length; i++) {
            final net.minecraft.util.Direction direction = directions[i];
    ...
    private ITextComponent outputLabel(net.minecraft.util.Direction direction) {
