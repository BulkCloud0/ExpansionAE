...
// Adapted from AE2 8.4 StorageBusPart to expose a dynamic partition filter.
...
public abstract class FilteredStorageBus extends UpgradeablePart
    ...
    public FilteredStorageBus(final ItemStack is) {
        super(is);
    ...
    public MEInventoryHandler<IAEItemStack> getInternalHandler() {
        ...
        if (target != null) {
            ...
            if (inv != null) {
                ...
                this.handler.setPartitionList(createPartitionList());
