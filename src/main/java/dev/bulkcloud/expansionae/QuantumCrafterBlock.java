...
public final class QuantumCrafterBlock extends AEBaseTileBlock<QuantumCrafterTile> {
    ...
    public ActionResultType onActivated(World world, BlockPos pos, PlayerEntity player, Hand hand,
        ...
        QuantumCrafterTile tile = getTileEntity(world, pos);
        if (tile != null) {
            if (!world.isRemote()) {
                ContainerOpener.openContainer(QuantumCrafterContainer.TYPE, player,
